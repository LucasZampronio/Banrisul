...
class Ex7Dia2
{
    ...
    public static void Resposta()
    {
        ...
        bool resultado1 = (num1 >=num2);
        bool resultado2 = (num1 <=num2);

        int resultadointeiro = Convert.ToInt16(resultado1);
        int resultadointeiros = Convert.ToInt16(resultado2);
        Console.WriteLine(resultadointeiro);
        Console.WriteLine(resultadointeiros);
